...
static int64_t min_sleep = 9999999;
...
bool
priority_compare(const struct list_elem *e, const struct list_elem *f,
  void *aux UNUSED){
...
{
  if(thread_current ()->priority_before == thread_current ()->priority){
